...
namespace DziennikUcznia.Controllers
{
    public class StudentGradesController : Controller
    {
        ...
        public StudentGradesController(SchoolDbContext_SQLServer context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Value,Type")] Grade grade)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Value,Type")] Grade grade)
        {
            if (id != grade.Id)
            {
                return NotFound();
